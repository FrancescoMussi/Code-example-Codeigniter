...
class Gallery_model extends CI_Model {
    ...
    function __construct()
    {
        ...
        $this->gallery_path_url = base_url() . 'images/';   // to link to the images folder
    }
    ...
    public function do_upload()
    {
        ...
        $this->upload->do_upload();  // call the loaded library upload and perform the upload, giving the config to the upload
